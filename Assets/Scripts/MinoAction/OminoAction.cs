...
{
    public class OminoAction : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            this._minoPos[1, 1] = Constants.MINO_TYPE_O;
            this._minoPos[2, 1] = Constants.MINO_TYPE_O;
            this._minoPos[1, 2] = Constants.MINO_TYPE_O;
            this._minoPos[2, 2] = Constants.MINO_TYPE_O;
        }

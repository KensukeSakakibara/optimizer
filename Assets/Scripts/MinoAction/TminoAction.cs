...
{
    public class TminoAction : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            this._minoPos[0, 1] = Constants.MINO_TYPE_T;
            this._minoPos[1, 1] = Constants.MINO_TYPE_T;
            this._minoPos[2, 1] = Constants.MINO_TYPE_T;
            this._minoPos[1, 2] = Constants.MINO_TYPE_T;
        }
        ...
        public void Turn(bool rightTurn)
        {
            ...
            switch (this._directionType) {
                ...
                case 1:
                    ...
                    this._mino2.SetActive(false);
                    this._mino3.SetActive(false);
                    this._minoPos[1, 0] = Constants.MINO_TYPE_T;
                    this._minoPos[1, 1] = Constants.MINO_TYPE_T;
                    this._minoPos[2, 1] = Constants.MINO_TYPE_T;
                    this._minoPos[1, 2] = Constants.MINO_TYPE_T;
                    break;

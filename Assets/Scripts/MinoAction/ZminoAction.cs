...
{
    public class ZminoAction : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            this._minoPos[1, 1] = Constants.MINO_TYPE_Z;
            this._minoPos[2, 1] = Constants.MINO_TYPE_Z;
            this._minoPos[0, 2] = Constants.MINO_TYPE_Z;
            this._minoPos[1, 2] = Constants.MINO_TYPE_Z;
        }
        ...
        public void Turn(bool rightTurn)
        {
            ...
            switch (this._directionType) {
                ...
                case 1:
                    ...
                    this._mino2.SetActive(false);
                    this._mino3.SetActive(false);
                    this._minoPos[1, 0] = Constants.MINO_TYPE_Z;
                    this._minoPos[1, 1] = Constants.MINO_TYPE_Z;
                    this._minoPos[2, 1] = Constants.MINO_TYPE_Z;
                    this._minoPos[2, 2] = Constants.MINO_TYPE_Z;
                    break;
                case 2:
                    this._mino0.SetActive(false);
                    this._mino1.SetActive(false);
                    ...
                    this._mino3.SetActive(false);
                    this._minoPos[0, 1] = Constants.MINO_TYPE_Z;
                    this._minoPos[1, 0] = Constants.MINO_TYPE_Z;
                    this._minoPos[1, 1] = Constants.MINO_TYPE_Z;
                    this._minoPos[2, 0] = Constants.MINO_TYPE_Z;
                    break;
                case 3:
                    this._mino0.SetActive(false);
                    this._mino1.SetActive(false);
                    ...
                    this._minoPos[0, 0] = Constants.MINO_TYPE_Z;
                    this._minoPos[0, 1] = Constants.MINO_TYPE_Z;
                    this._minoPos[1, 1] = Constants.MINO_TYPE_Z;
                    this._minoPos[1, 2] = Constants.MINO_TYPE_Z;
                    break;
